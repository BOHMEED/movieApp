...
const Lkol = () => {
    const [movies,setMovies]=useState([
        ...
        },
        {
          ...
          description:"Archie, Betty, Jughead and Veronica tackle being teenagers in a town that is rife with sinister hMainenings and blood-thirsty criminals.",
          rate:"2.5",
        },
        {
          name:"Carnival Row",
        ...
        },
        {
          name:"Home Alone 2",
          genre:"Comedy",
          image:"https://lumiere-a.akamaihd.net/v1/images/homealone2_7706aa6d.jpeg?region=0%2C0%2C584%2C876",
          description:"blbalbalbalblablalblalbalblalbal.",
          rate:"1.5",
        },
      ...
      const addmovi=()=>{setMovies([...movies,newmovie])}
  return (
    <div>
      {showAdd?<AddModal addmovi={addmovi} newmovie={newmovie} setnewmovie={setnewmovie} setshowAdd={setshowAdd} />:null}
      
      <Navbar setshowAdd={setshowAdd} setrecherche={setrecherche} />
      <Home recherche={recherche} movies={movies} />
    </div>
  )
}
